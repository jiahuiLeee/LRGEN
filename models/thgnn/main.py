...
def main(args):
    ...
    for data_seed in range(1):
        ...
        for model_seed in range(1):
            ...
            model = THGNN(in_size=x.shape[1], 
                          out_size=1, 
                          hidden=args.hidden, 
                          norm=False,
                          use_attnFusioner=use_attnFusioner, 
                          tribe_encoder_type=args.tribe_gnn,
                          local_layer_num=args.local_num_layer)
            
            model.load_state_dict(torch.load('/home/ljh/RGEN_A/models/TH-GNN/TH-GNN.pth'))
...
if __name__ == '__main__':
    ...
    ap.add_argument('--num_epoch', type=int, default=200, help='training epoch num')
    ap.add_argument('-path_x', type=str, default='./financial_ratios_2023.npy', help='node attribute files (.npy, financial statements for each listed company)')
    ap.add_argument('--path_y', type=str, default='./2023_2_label.npy', help='node classification label file path, risk or not.')
    ap.add_argument('--path_tribe_files', type=str, default='/home/ljh/RGEN_A/data/CKG/json_output/2023')
    ap.add_argument('--path_tribe_order', type=str, default='/home/ljh/RGEN_A/data/CKG/company_filenames.json')
