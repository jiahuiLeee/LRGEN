...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        node_rep = gnn.forward(train_fin_index_emb, node_type, train_edge_time, edge_index, train_graph.etypes)
        res  = classifier.forward(node_rep)
